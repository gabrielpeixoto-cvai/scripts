...
-- Dzen/Conky
myXmonadBar = "dzen2 -x '0' -y '0' -h '24' -w '650' -ta 'l' -fg '#FFFFFF' -bg '#1B1D1E'"
myStatusBar = "conky -c /home/gaburiero/.xmonad/.conky_dzen | dzen2 -x '650' -w '716' -h '24' -ta 'r' -bg '#1B1D1E' -fg '#FFFFFF' -y '0'"
myBitmapsDir = "/home/gaburiero/.xmonad/dzen2"
--}}}
-- Main {{{
main = do
...
keys' conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
    ...
    , ((modMask,                    xK_q        ), spawn "/home/gaburiero/.cabal/bin/xmonad --recompile && /home/gaburiero/.cabal/bin/xmonad --restart")
    ]
    ++
